...
2. Once the email copy of the license agreement has been received at printf '\e]8;;https://www.ulpgc.es\e\\ulpgs\e]8;;\e\\\n' ** ulpgs https://www.ulpgc.es**, you will receive an email with a password. This password can be used to extract the database [AICow-Dataset v1.0.zip](https://github.com/Shahid-Ismail/Test/files/10341674/AICow-Dataset.v1.0.zip).
